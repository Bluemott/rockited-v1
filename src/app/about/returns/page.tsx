              ...
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    ...
                    satisfied with your purchase, you can return it within 30 days of delivery 
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Items must be in their original condition, unused, and with all tags attached.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
            ...
            <CardContent className="pt-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <ol className="space-y-3 text-muted-foreground list-decimal list-inside">
                  <li>Contact our customer service team to initiate a return. You can reach us at support@rockited.com or call (555) 123-4567.</li>
                  <li>We'll provide you with a return authorization number and return shipping label.</li>
                  <li>Package the item securely in its original packaging (if available).</li>
                  <li>Include the return authorization number and your order number in the package.</li>
              ...
              <div className="flex items-start space-x-4 mb-4">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
                    <li>Credit/Debit Cards: 5-7 business days after we receive the returned item</li>
