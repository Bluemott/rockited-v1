          ...
          <Card>
            <CardContent className="pt-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-muted-foreground mb-4">
                  Permission is granted to temporarily download one copy of the materials on ROCK IT ED's 
            ...
            <CardContent className="pt-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-muted-foreground">
                  ...
                  for delays caused by shipping carriers or other factors beyond our control. 
                  Please refer to our Shipping Information page for more details.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-muted-foreground mb-4">
                  In no event shall ROCK IT ED or its suppliers be liable for any damages (including, 
                  without limitation, damages for loss of data or profit, or due to business interruption) 
                  arising out of the use or inability to use the materials on ROCK IT ED's website, 
                  even if ROCK IT ED or a ROCK IT ED authorized representative has been notified orally 
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <p className="text-muted-foreground">
                  The materials appearing on ROCK IT ED's website could include technical, typographical, 
                  or photographic errors. ROCK IT ED does not warrant that any of the materials on its 
                  website are accurate, complete, or current. ROCK IT ED may make changes to the materials 
