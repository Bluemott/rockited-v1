...
export default function FeaturedProducts({ products }: FeaturedProductsProps) {
  ...
  return (
    <section 
      className="relative py-20 -mt-10 floating-content"
    >
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto">
            Discover our most popular products, loved by customers for their exceptional quality and design.
          </p>
        </MotionDiv>
              ...
              <CardContent className="space-y-3 flex-grow">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <Badge variant={getStockStatus()[product.stock_status]?.variant || 'outline'} className="text-xs">
