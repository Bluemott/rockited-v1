  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-success text-success-foreground hover:opacity-90",
        warning:
          "border-transparent bg-accent-orange text-accent-orange-foreground hover:opacity-90",
      },
    },
    defaultVariants: {
      variant: "default",
