...
export const recoveryResources: RecoveryResource[] = [
  ...
  // 12-Step Programs
  {
    ...
    description:
      "A worldwide fellowship of men and women who help each other stay sober. Free to all who want to recover from alcoholism.",
    phone: "212-870-3400",
  ...
  },
  {
    ...
    category: "12-Step Programs",
    description:
      "A global, community-based organization with a multi-lingual and multicultural membership. NA was founded in 1953.",
  ...
  // Treatment Centers
  {
    ...
    description:
      "One of the nation's leading nonprofit addiction treatment, mental health, and recovery organizations.",
  ...
  },
  {
    ...
    category: "Treatment Centers",
    description:
      "A nationally recognized nonprofit dedicated to addiction and behavioral healthcare treatment, prevention, and education.",
  ...
  // Online Resources
  {
    ...
    description:
      "A free online recovery tool offering 130 weekly online meetings for those recovering from addiction and related issues.",
  ...
  },
  {
    ...
    category: "Online Resources",
    description:
      "A science-based program that helps people recover from addiction through self-empowerment and self-reliance.",
  ...
  },
  {
    ...
    category: "Online Resources",
    description:
      "Comprehensive directory of addiction treatment centers, support groups, and recovery resources.",
  ...
  // Government Resources
  {
    ...
    description:
      "Substance Abuse and Mental Health Services Administration - Leading public health agency focused on behavioral health.",
    phone: "1-800-662-4357",
  ...
  },
  {
    ...
    category: "Support Groups",
    description:
      "A twelve-step program for friends and family members of those who are addicted to drugs or alcohol.",
  ...
  },
  {
    ...
    category: "Support Groups",
    description:
      "A Twelve Step, Twelve Tradition program of people who grew up in an alcoholic or otherwise dysfunctional home.",
  ...
  // Helplines
  {
    ...
    category: "Helplines",
    description:
      "24/7 confidential helpline providing information, support, and referrals for substance abuse issues.",
  ...
  },
  {
    ...
    category: "Helplines",
    description:
      "Provides personalized support and resources for families struggling with their son's or daughter's substance use.",
