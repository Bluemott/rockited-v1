...
const defaultDescription = optimizeMetaDescription('Discover premium products with quality, style, and innovation. Shop the best selection online.');
...
export function generateHomeMetadata(): Metadata {
  return {
    ...
    keywords: ['premium products', 'quality', 'style', 'innovation', 'online shopping', 'ROCK IT ED'],
    openGraph: {
...
export function generateProductMetadata(product: WooProduct): Metadata {
  ...
  const rawDescription = seoDescription || 
  ...
  const productImage = customOGImage || product.images[0]?.src || `${siteUrl}/placeholder-product.jpg`;
...
export function generateProductsPageMetadata(): Metadata {
  const description = optimizeMetaDescription('Browse our complete collection of premium products. Discover quality, style, and innovation in every item.');
  return {
...
export function generateNotFoundMetadata(): Metadata {
  const description = optimizeMetaDescription('The page you are looking for could not be found. Return to our homepage or browse our products.');
  return {
...
export function generateErrorMetadata(): Metadata {
  const description = optimizeMetaDescription('An unexpected error occurred. Please try again or return to our homepage.');
  return {
...
export function generateAboutMetadata(): Metadata {
  const description = optimizeMetaDescription('Learn more about ROCK IT ED - our mission, values, and commitment to providing premium products with exceptional quality and customer service.');
  return {
...
export function generateCustomerServiceMetadata(): Metadata {
  const description = optimizeMetaDescription('Get help with your orders, product questions, returns, and more. Our dedicated customer service team is here to assist you.');
  return {
...
export function generateReturnsMetadata(): Metadata {
  const description = optimizeMetaDescription('Learn about our return and exchange policy. We offer hassle-free returns within 30 days of purchase.');
  return {
...
export function generateFAQMetadata(): Metadata {
  const description = optimizeMetaDescription('Find answers to common questions about our products, shipping, returns, payments, and more.');
  return {
...
export function generatePrivacyMetadata(): Metadata {
  const description = optimizeMetaDescription('Read our privacy policy to understand how we collect, use, and protect your personal information.');
  return {
...
export function generateTermsMetadata(): Metadata {
  const description = optimizeMetaDescription('Read our terms of service to understand the rules and regulations for using our website and services.');
  return {
...
export function generateShippingMetadata(): Metadata {
  const description = optimizeMetaDescription('Learn about our shipping options, delivery times, shipping costs, and tracking information.');
  return {
...
export function generateContactMetadata(): Metadata {
  const description = optimizeMetaDescription('Get in touch with ROCK IT ED. Contact our team for product inquiries, order support, or general questions.');
  return {
...
export function generateCategoryMetadata(category: { name: string; slug: string; description?: string }): Metadata {
  ...
  const categoryDescription = category.description 
    ...
    : optimizeMetaDescription(`Browse ${category.name} products at ${siteName}. Discover quality, style, and innovation.`);
...
export function generateResourcesMetadata(): Metadata {
  const description = optimizeMetaDescription('Find recovery resources, support groups, treatment centers, and helpful organizations for addiction recovery and 12-step programs.');
  return {
    title: `Resources & Blog | ${siteName}`,
    description,
    keywords: ['recovery resources', 'support groups', 'treatment centers', '12-step programs', 'recovery blog', siteName],
    openGraph: {
      title: `Resources & Blog | ${siteName}`,
      description,
      type: 'website',
 ...
 */
export function generateBlogPostMetadata(post: { title: string; excerpt: string; slug: string; featuredImage?: string; seoKeywords?: string[]; publishedAt: Date; author: string }): Metadata {
...
export function generateBlogListingMetadata(): Metadata {
  const description = optimizeMetaDescription('Read recovery-related articles, guides, and resources to support your journey. Expert insights, personal stories, and helpful information.');
  return {
    title: `Blog Articles | ${siteName}`,
    description,
    keywords: ['recovery blog', 'recovery articles', 'recovery guides', 'addiction recovery', siteName],
    openGraph: {
      title: `Blog Articles | ${siteName}`,
      description,
      type: 'website',
...
export function generateCartMetadata(): Metadata {
  const description = optimizeMetaDescription('Review your shopping cart items and proceed to checkout.');
  return {
...
export function generateCheckoutMetadata(): Metadata {
  const description = optimizeMetaDescription('Complete your purchase securely with our checkout process.');
  return {
...
export function generateCheckoutSuccessMetadata(): Metadata {
  const description = optimizeMetaDescription('Thank you for your order! Your purchase has been confirmed and you will receive an email confirmation shortly.');
  return {
...
export function generateCheckoutCancelMetadata(): Metadata {
  const description = optimizeMetaDescription('Your payment was cancelled. You can return to your cart to complete your purchase.');
  return {
